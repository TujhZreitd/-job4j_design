...
class NonCollisionMapTest {
    ...
    void whenCheckPutWithExpand() {
        ...
        assertThat(map.put(9, "10")).isFalse();
        assertThat(map.get(4)).isEqualTo("4");
    ...
    @Test
    void whenCheckPutOther() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        map.put(null, "0000");
        assertThat(map.put(null, "6")).isFalse();
        assertThat(map).hasSize(1);
    }

    @Test
    void whenCheckGetWithPut() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        map.put(null, "0000");
        map.put(1, "1");
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.get(null)).isEqualTo("0000");
        assertThat(map.get(9)).isEqualTo(null);
        assertThat(map.get(0)).isEqualTo(null);
    }

    @Test
    void whenCheckGetOther() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.get(1)).isEqualTo(null);
        assertThat(map.get(null)).isEqualTo(null);
        map.put(null, "5");
        assertThat(map.get(null)).isEqualTo("5");
    }

    @Test
    void whenCheckRemoveWithGet() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        map.put(null, "1234");
        map.put(15, "1");
        assertThat(map.get(null)).isEqualTo("1234");
        assertThat(map.remove(null)).isEqualTo(true);
        assertThat(map.get(null)).isEqualTo(null);
    }

    @Test
    void whenCheckRemoveOther() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        map.put(null, "1234");
        map.put(15, "1");
        assertThat(map.get(null)).isEqualTo("1234");
        assertThat(map.remove(0)).isEqualTo(false);
        assertThat(map.get(null)).isEqualTo("1234");
    }
}